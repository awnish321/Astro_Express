...
public class LoadAstrologerListAdapter extends RecyclerView.Adapter<LoadAstrologerListAdapter.ImageViewHolder> {
    private Context context;
    private List<AstrologerResponseModel.Result> resultList;

    public LoadAstrologerListAdapter(Context context, List<AstrologerResponseModel.Result> resultList) {

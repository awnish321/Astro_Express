...
public class LoadAstrologerTrendingListAdapter extends RecyclerView.Adapter<LoadAstrologerTrendingListAdapter.ImageViewHolder> {
    private Context context;
    private List<AstrologerResponseModel.Result> resultList;

    public LoadAstrologerTrendingListAdapter(Context context, List<AstrologerResponseModel.Result> resultList) {
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        if (itemData.isOnlineForCall() || itemData.isOnlineForChat())
        {
